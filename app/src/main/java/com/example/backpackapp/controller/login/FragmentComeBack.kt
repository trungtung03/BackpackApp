...
class FragmentComeBack : BaseFragment<FragmentComebackBinding>() {
    companion object {
        fun newInstance() = FragmentComeBack()
        fun removeInstance() = FragmentComeBack()
    }
    ...
    override fun initView(view: View) {
                ...
                object : BiometricPrompt.AuthenticationCallback() {
                    ...
                    override fun onAuthenticationSucceeded(result: BiometricPrompt.AuthenticationResult) {
                        ...
                        requireActivity().supportFragmentManager.beginTransaction()
                            ...
                            .remove(FragmentLogin.removeInstance()).addToBackStack(null).commitAllowingStateLoss()
                    }
        ...
        val preferences = activity?.let { SharedPreferences(it, URL) }
        activity?.let {
            Glide.with(it).load(preferences?.urlAvatar).error(R.drawable.avatar_default)
