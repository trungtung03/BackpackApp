...
import com.example.backpackapp.view.guide.ViewPagerOverviewAdapter
import com.example.backpackapp.base.BaseActivity
import com.example.backpackapp.controller.login.FragmentLogin
import com.example.backpackapp.custom.ZoomOutPageTransformer
import com.example.backpackapp.databinding.ActivityOverviewBinding
import com.example.backpackapp.units.GA.COUNT_CLICK
...
class Overview : BaseActivity() {
    ...
    private fun uploadUidNewUser() {
        FragmentLogin.insertInformation()
    }
}