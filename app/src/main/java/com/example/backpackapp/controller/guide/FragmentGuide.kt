...
package com.example.backpackapp.controller.guide
...
import com.example.backpackapp.view.guide.ViewPagerGuideAdapter
        ...
        fragmentGuideBinding.btnNextGuide.setOnClickListener {
            ...
            when (GA.COUNT_CLICK) {
                ...
                4 -> {
                    ...
                    openActivityFullSize(Overview::class.java)
