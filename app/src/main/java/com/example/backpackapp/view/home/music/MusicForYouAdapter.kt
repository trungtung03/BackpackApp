package com.example.backpackapp.view.home.music
...
import com.example.backpackapp.view.home.music.MusicForYouAdapter.ViewHolder
...
class MusicForYouAdapter(val context: Context) :
    ...
    class ViewHolder(itemView: View) : BaseViewHolder<LibraryMusic>(itemView) {
        ...
        override fun bindViewHolder(context: Context?, data: LibraryMusic?, position: Int) {
            ...
            itemView.tv_song_title_rcv_library_music.text = data?.songTitle
    ...
    override fun setData(mList: ArrayList<LibraryMusic>) {
        mDataList = mList
